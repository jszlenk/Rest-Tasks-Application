$(document).ready(function () {
    // const apiRoot = 'https://localhost:8080/v1/';
    // const trelloApiRoot = 'https://localhost:8080/v1/trello/';
    const apiRoot = 'https://lit-shore-95037.herokuapp.com/v1/';
    const trelloApiRoot = 'https://lit-shore-95037.herokuapp.com/v1/trello/';
    ...
    function getAllTasks() {
        ...
        $.ajax({
            ...
            success: function (tasks) {
                tasks.forEach(task => { availableTasks[task.id] = task;
            });
